...
-- Añadido en migration v12 actualizada: fecha de visita independiente por stop
ALTER TABLE stops ADD COLUMN date_assigned DATE NULL COMMENT 'Fecha de esta visita concreta (informe independiente por día)';
