...
interface KpiDefinitionDao {
    ...
    /** KPIs visibles para el sector dado — consulta síncrona para VisitaViewModel */
    @Query("SELECT * FROM kpi_definitions WHERE (sector = :sector OR sector = 'common') AND visible = 1 ORDER BY orderIndex ASC")
    suspend fun getVisible(sector: String): List<KpiDefinitionEntity>
}
