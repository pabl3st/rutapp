...
val ColorVisitado  = Color(0xFF2E7D32)
val ColorPendiente = Color(0xFF1565C0)
val ColorPospuesto = Color(0xFFE65100)
val ColorNoVisitar = Color(0xFF546E7A)
...
val RutasTypography = Typography(
...
fun RutasAppTheme(darkTheme: Boolean = isSystemInDarkTheme(), content: @Composable () -> Unit) {
    ...
    MaterialTheme(colorScheme = colorScheme, typography = RutasTypography, content = content)
}
