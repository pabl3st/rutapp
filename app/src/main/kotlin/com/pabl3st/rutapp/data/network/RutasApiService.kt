...
data class StopDto(
    ...
    @LenientDouble val lat: Double?,
    @LenientDouble val lng: Double?,
    @Json(name = "order_index")   val orderIndex: Int        = 0,
    val status: String,
    val notes: String?,
    ...
    @Json(name = "pdv_open")         @LenientBoolean val pdvOpen: Boolean = true,
    @Json(name = "pdv_inactive")     @LenientBoolean val pdvInactive: Boolean = false,
    @Json(name = "visit_frequency")  @LenientString val visitFrequency: String? = null,
    ...
    @Json(name = "gps_lat_visit") @LenientDouble val gpsLatVisit: Double? = null,
    @Json(name = "gps_lng_visit") @LenientDouble val gpsLngVisit: Double? = null,
)
